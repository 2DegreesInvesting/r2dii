...
### **Visualization:** This is one of several visualizations possible. It's similar to what [tiltPlot](https://2degreesinvesting.github.io/tiltPlot/) will do.

```{r echo=show_code}
shinyApp(
  ui = fluidPage(
    sidebarPanel(inputPanel(
      selectInput("sector", "Sector:", choices = unique(metric$sector)))
    ),

...
params:
  loanbook: "data/from-bank/loanbook.csv"
  abcd: "data/from-2dii/abcd.csv"
  scenario: "data/from-2dii/scenario.csv"
  regions: "data/from-2dii/regions.csv"
  to_validate: "data/validation/to_validate.csv"
  validated: "data/validation/validated.csv"
  sector: "oil and gas"
  show_code: FALSE
---
...
### Match bank data with 2DII data
